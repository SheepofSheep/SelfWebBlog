      ...
      <div class="write-panel glass-card" @click.stop>
        <div class="write-head">
          ...
          <div class="write-head-right">
            ...
            <span v-else-if="draftStatus === 'saved'" class="draft-indicator saved"
        ...
        <div class="write-toolbar">
          <button class="tool-btn" title="图片" aria-label="插入图片" @click="triggerImageUpload">
            <Image :size="16" />
          </button>
          ...
          <button class="tool-btn" title="引用" aria-label="插入引用" @click="insertMarkdown('> ')">
            <Quote :size="16" />
          </button>
          <button class="tool-btn" title="列表" aria-label="插入列表" @click="insertMarkdown('- ')">
            <List :size="16" />
          </button>
        </div>
...
.modal-enter-from .write-panel,
.modal-leave-to .write-panel {
